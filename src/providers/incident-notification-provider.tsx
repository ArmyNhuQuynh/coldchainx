...
const EVENT_MESSAGES: Record<string, string> = {
  ...
  IncidentFallbackRecorded: "Phương án fallback của Incident vừa được cập nhật.",
  IncidentRescueDispatched: "Xe cứu hộ nội bộ đã được điều.",
  IncidentTransloadCompleted: "Việc sang hàng đã hoàn tất; chuyến đã tiếp tục.",
  ...
  IncidentTripContinued: "Incident đã được xử lý tại chỗ; chuyến đã tiếp tục.",
