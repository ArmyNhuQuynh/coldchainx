  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-100 p-6 md:p-8 text-center animate-in fade-in zoom-in-95 duration-300">
        {/* Brand Header */}
        <div className="mb-6">
          <span className="inline-block text-xs font-bold tracking-wider text-sky-600 uppercase bg-sky-50 px-3 py-1 rounded-full">
            ColdChainX Logistics
          </span>
        </div>

        {/* Success Icon */}
        <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-50 text-emerald-500 ring-8 ring-emerald-50/50 animate-bounce-short">
        ...
        <p className="mt-3 text-sm text-slate-600 leading-relaxed">
          ...
          <strong className="text-slate-800">ColdChainX</strong> để tiếp tục
          hành trình.
        </p>

        {/* Payment Summary Box (Optional metadata if present in URL) */}
        ...
        {/* Instruction Note */}
        <div className="mt-6 p-3.5 rounded-xl bg-amber-50/80 border border-amber-200/60 text-xs text-amber-900 leading-normal">
          💡 Bạn có thể đóng tab này và quay lại ứng dụng{" "}
          <span className="font-semibold">ColdChainX</span>.
        </div>
