      ...
      {canPayout && (
        <form className="rounded-lg border bg-card p-5" onSubmit={form.handleSubmit(handleSubmit)} noValidate>
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            <div className="space-y-2"><Label htmlFor="refundAmount">Số tiền hoàn</Label><Input id="refundAmount" type="number" min="1" step="1000" {...form.register("refundAmount")} /><p className="text-xs text-destructive">{form.formState.errors.refundAmount?.message}</p></div>
