...
import { Clock3, RefreshCw, Search, WalletCards } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      {incidentsQuery.isError ? (
        ...
        <Tabs value={tab} onValueChange={setTab}>
          ...
          <TabsContent value="history"><ExpenseTable incidents={reimbursed} isLoading={incidentsQuery.isLoading} onView={setDetailIncident} onReview={setReviewIncident} onReimburse={setReimburseIncident} /></TabsContent>
        </Tabs>
      )}
