...
export const DiscrepancyDetailSchema = z.object({
  ...
  expectedCbm: z.number(),
  actualCbm: z.number(),
  expectedLengthCm: z.number(),
  actualLengthCm: z.number(),
  expectedWidthCm: z.number(),
  actualWidthCm: z.number(),
  expectedHeightCm: z.number(),
  actualHeightCm: z.number(),
  isQuantityDifferent: z.boolean(),
  isWeightDifferent: z.boolean(),
  isCbmDifferent: z.boolean(),
  isLengthDifferent: z.boolean(),
  isWidthDifferent: z.boolean(),
  isHeightDifferent: z.boolean(),
